...
public class GetExposedEngineRuleService implements Service {
	...
	public ResponseEntity<?> execute(Object... parameters) {
		if (parameters[0] instanceof String) {
			...
			return getRuleService(ruleId);
		}
		return paramError;
	}

	private ResponseEntity<?> getRuleService(String ruleId) {
		return engineExposer.getExposedEngine().getRule(ruleId);
	}
